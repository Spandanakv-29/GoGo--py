...
const categories = [
  ...
  { name: "Restaurant", icon: Utensils, count: 2189, color: "from-red-600 to-pink-600" },
  { name: "Art", icon: Palette, count: 2460, color: "from-purple-600 to-indigo-600" },
  { name: "Culture", icon: Theater, count: 1875, color: "from-green-600 to-emerald-600" },
  ...
  <div className="space-y-12">
    ...
    <section className="bg-[#DDE6ED]/80 backdrop-blur-sm rounded-3xl shadow-lg border-2 border-[#3C5070]/10 p-8">
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            "Explore Prague's Old Town and Wawel Castle",
  ...
  <TabsContent value="currency">
    <div className="max-w-6xl mx-auto space-y-8">
      ...
      <div className="text-center mb-8">
        ...
        <h2 className="text-4xl font-black text-[#112250] mb-4">Real-Time Currency Converter</h2>
        <p className="text-xl text-[#3C5070] max-w-2xl mx-auto">
          Convert currencies instantly with live exchange rates! Perfect for travelers planning their budget and understanding local prices. 💰
        </p>
      </div>
      ...
      <div className="bg-[#DDE6ED]/80 backdrop-blur-sm rounded-3xl shadow-lg border-2 border-[#3C5070]/10 p-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              <Input
                ...
                className="text-3xl font-bold bg-[#F8EFE5]/30 border-2 border-[#3C5070]/20 rounded-2xl p-6 text-[#112250] placeholder:text-[#3C5070]/60 focus:ring-4 focus:ring-[#3C5070]/30"
              />
          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              <div className="text-3xl font-bold bg-[#F8EFE5]/30 border-2 border-[#3C5070]/20 rounded-2xl p-6 text-[#112250] min-h-[80px] flex items-center">
                {isConverting ? (
                  <div className="flex items-center space-x-3">
                    <div className="animate-spin rounded-full h-6 w-6 border-b-2 border-[#3C5070]"></div>
                    <span className="text-lg text-[#3C5070]">Converting...</span>
                  </div>
                ) : conversionError ? (
                  ...
                  <div className="w-full">
                    ...
                    {exchangeRate && (
                      <div className="text-sm text-[#3C5070] mt-2">
              ...
              {convertedAmount !== null && (
                <div className="absolute bottom-4 right-4">
                  <Button
                    variant="ghost"
                    size="icon"
                    onClick={() => copyToClipboard(convertedAmount?.toString() || "")}
                    className="w-8 h-8 rounded-full bg-[#3C5070]/10 hover:bg-[#3C5070]/20"
                  >
                    <Copy className="w-4 h-4 text-[#3C5070]" />
                  </Button>
        ...
        {lastUpdated && (
          <div className="mt-6 text-center">
            <div className="bg-[#F8EFE5]/30 rounded-2xl p-4 border border-[#3C5070]/10">
              <div className="flex items-center justify-center space-x-2 text-sm text-[#3C5070]">
                <TrendingUp className="w-4 h-4" />
                <span>Last updated: {lastUpdated.toLocaleTimeString()}</span>
                <span>•</span>
                <span>Rates provided by exchangerate-api.com</span>
              </div>
            </div>
          </div>
        )}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <Button
                        variant="ghost"
                        size="icon"
                        onClick={() => copyToClipboard(conversion.result.toString())}
                        className="absolute top-2 right-2 w-6 h-6 rounded-full bg-[#3C5070]/10 hover:bg-[#3C5070]/20"
                      >
                        <Copy className="w-3 h-3 text-[#3C5070]" />
                      </Button>
                    </div>
                    <p className="text-xs text-[#3C5070] mt-1">
      ...
      <div className="bg-[#DDE6ED]/80 backdrop-blur-sm rounded-3xl shadow-lg border-2 border-[#3C5070]/10 p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            ...
            { from: "EUR", to: "GBP", label: "Euro to British Pound" },
            { from: "USD", to: "CAD", label: "US Dollar to Canadian Dollar" },
            { from: "USD", to: "AUD", label: "US Dollar to Australian Dollar" },
            { from: "GBP", to: "EUR", label: "British Pound to Euro" },
            { from: "USD", to: "CHF", label: "US Dollar to Swiss Franc" },
            { from: "EUR", to: "JPY", label: "Euro to Japanese Yen" }
          ].map((pair, index) => (
            <Button
              key={index}
              variant="outline"
            ...
            >
              <div className="flex items-center space-x-3">
                <div className="flex items-center space-x-1">
                  <span>{currencies.find(c => c.code === pair.from)?.flag}</span>
                  <span className="font-bold">{pair.from}</span>
                </div>
                <span className="text-[#3C5070]">→</span>
                <div className="flex items-center space-x-1">
                  <span>{currencies.find(c => c.code === pair.to)?.flag}</span>
                  <span className="font-bold">{pair.to}</span>
                </div>
              </div>
              <p className="text-sm text-[#3C5070] mt-1">{pair.label}</p>
            </Button>
          ))}
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-[#DDE6ED]/80 backdrop-blur-sm rounded-2xl shadow-lg border-2 border-[#3C5070]/10 p-6 text-center">
          ...
          <p className="text-[#3C5070] text-sm">Live exchange rates updated in real-time from reliable financial data sources.</p>
        </div>
        
        <div className="bg-[#DDE6ED]/80 backdrop-blur-sm rounded-2xl shadow-lg border-2 border-[#3C5070]/10 p-6 text-center">
          <div className="text-4xl mb-4">🌍</div>
          <h4 className="text-lg font-bold text-[#112250] mb-2">35+ Currencies</h4>
          <p className="text-[#3C5070] text-sm">Support for major world currencies including USD, EUR, GBP, JPY, and many more.</p>
        </div>
        
        <div className="bg-[#DDE6ED]/80 backdrop-blur-sm rounded-2xl shadow-lg border-2 border-[#3C5070]/10 p-6 text-center">
          <div className="text-4xl mb-4">📱</div>
          <h4 className="text-lg font-bold text-[#112250] mb-2">Travel-Friendly</h4>
          <p className="text-[#3C5070] text-sm">Perfect for travelers to quickly understand local prices and plan budgets.</p>
        </div>
      </div>
    </div>
  </TabsContent>
      ...
      {showLoginModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center">
          <Card className="max-w-md w-full p-8 bg-[#DDE6ED]/95 border-2 border-[#3C5070]/20 rounded-3xl shadow-2xl">
            <CardHeader className="flex flex-col items-center space-y-2 mb-6">
              <h2 className="text-3xl font-bold text-[#112250]">
                {isSignUpMode ? "Create Account" : "Login"}
              </h2>
              <p className="text-[#3C5070]">
                {isSignUpMode ? "Sign up to discover amazing places!" : "Welcome back!"}
              </p>
            </CardHeader>
            <CardContent className="space-y-4">
              <Input type="email" placeholder="Email" className="bg-[#F8EFE5]/50 border-2 border-[#3C5070]/20 rounded-2xl text-[#112250] placeholder:text-[#3C5070]/60 focus:ring-4 focus:ring-[#3C5070]/30" />
              <Input type="password" placeholder="Password" className="bg-[#F8EFE5]/50 border-2 border-[#3C5070]/20 rounded-2xl text-[#112250] placeholder:text-[#3C5070]/60 focus:ring-4 focus:ring-[#3C5070]/30" />
              <Button className="w-full bg-gradient-to-r from-[#3C5070] to-[#112250] hover:from-[#112250] hover:to-[#3C5070] rounded-full px-8 py-3 text-lg font-bold shadow-lg">
                {isSignUpMode ? "Sign Up" : "Login"}
              </Button>
              <Button variant="link" className="text-[#3C5070]" onClick={() => setIsSignUpMode(!isSignUpMode)}>
                {isSignUpMode ? "Already have an account? Login" : "Don't have an account? Sign Up"}
              </Button>
              <Button variant="ghost" className="absolute top-4 right-4 text-[#3C5070]" onClick={() => setShowLoginModal(false)}>
                X
              </Button>
            </CardContent>
          </Card>
